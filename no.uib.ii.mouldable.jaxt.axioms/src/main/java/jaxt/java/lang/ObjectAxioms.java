 ...
 * 
 */
abstract public class ObjectAxioms implements
		jaxt.framework.RequiredAxioms<Object> {
	...
	public static void equalsProperty2symmetric(Object x, Object y) {
		if (x != null && y != null)
			assertEquals("Compares (" + x.getClass() + ")" + x.toString()
					+ " (" + y.getClass() + ")" + y.toString(), x.equals(y), y
					.equals(x));
	}
	 ...
	 */
	public static void equalsProperty4function(Object x, Object y, int r) {
		if (x != null && y != null) {
			boolean b = x.equals(y);
			for (int i = 0; i < r; i++) {
				// assuming x remains unchanged
				assertEquals("Compares " + i + " out of " + r + " times ("
						+ x.getClass() + ")" + x.toString() + " ("
						+ y.getClass() + ")" + y.toString(), b, x.equals(y));
			}
		}
	}
	...
	public static void equalsProperty5null(Object x) {
		if (x != null)
			assertFalse("Compares (" + x.getClass() + ")" + x.toString(), x
					.equals(null));
	}
	...
	public static void hashCodeProperty1function(Object a, int r) {
		...
		for (int i = 0; i < r; i++) {
			...
			assertEquals("Checks " + i + " out of " + r + " times ("
					+ a.getClass() + ")" + a.toString(), h, a.hashCode());
		}
	}
	...
	public static void hashCodeProperty2congruenceEquals(Object a, Object b) {
		if (a.equals(b))
			assertEquals("Checks (" + a.getClass() + ")" + a.toString() + " ("
					+ a.getClass() + ")" + a.toString(), a.hashCode(), b
					.hashCode());
	}
